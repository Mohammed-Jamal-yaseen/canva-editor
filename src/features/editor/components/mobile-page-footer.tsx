...
export const MobilePageFooter = ({
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 h-16 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border dark:border-slate-700 flex items-center justify-around px-2 z-[60] lg:hidden">
      <button 
        onClick={onAddPage}
        className="flex flex-col items-center gap-y-1 group"
      >
        <Plus className="size-5 text-slate-600 dark:text-slate-400" />
      ...
      <button 
        ...
        className="flex flex-col items-center gap-y-1 group"
      >
        <CopyPlus className="size-5 text-slate-600 dark:text-slate-400" />
      ...
      <button 
        ...
        className="flex flex-col items-center gap-y-1 group"
      >
        <Trash className="size-5 text-slate-600 dark:text-slate-400" />
        <span className="text-[10px] font-bold">حذف</span>
      </button>

      <button className="flex flex-col items-center gap-y-1 group">
        <CheckCircle2 className="size-5 text-slate-600 dark:text-slate-400" />
